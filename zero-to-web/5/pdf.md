...
보고서를 식별할 수 있는 고유한 웹 주소를 설정하고 관리하는 단계입니다.

1. 링크 생성: \[공개하기] 버튼을 클릭하면 보고서로 연결되는 공개 링크가 즉시 생성됩니다.
2. 링크 수정: 기본으로 생성된 주소 외에 기업만의 고유한 주소를 사용하고 싶다면 \[공개 링크 수정하기] 버튼을 누릅니다.
3. 정보 입력 및 가용성 확인:
...
4. 저장: 사용 가능한 주소임이 확인되면 \*\*\[링크 저장하기]\*\*를 눌러 설정을 완료합니다.
