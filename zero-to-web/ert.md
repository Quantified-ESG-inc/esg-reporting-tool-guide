...
* 시점 가이드 확인: 상세한 발간 전략은 [우리 회사에 맞는 발간 시점 정하기](https://app.gitbook.com/s/GKCm3jv7oKZo5mOumj8n/undefined) 문서를 참고하시기  바랍니다.&#x20;



**🔍 로드맵 활용 방법**

아래의 참고용  로드맵을 바탕으로 우리 회사만의 ESG 보고서 발간 프로젝트 일정을 기획해 보세요.

* 예시 기준: 하단의 로드맵은 매년 6월 말 KCGS 평가 대응을 목표로 하는 기업을 위한 표준 일정 예시입니다.
* 일정 역산: 6월 말 발간을 위해서는 늦어도 1\~2월에는 프로젝트를 시작해야 하며, 가장 많은 시간이 소요되는 '데이터 수집(3단계)' 기간을 충분히 확보하는 것이 핵심입니다.
